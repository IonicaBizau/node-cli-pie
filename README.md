...
If you are using this library in one of your projects, add it in this list. :sparkles:
 ...
 - [`dupie`](https://github.com/AndyMardell/dupie#readme) (by Andy Mardell)—Disk Usage Pie Graph
 - [`free-pie`](https://github.com/singularitti/free-pie#readme) (by Qi Zhang)—A simple command-line pie chart plotter for memeory information
